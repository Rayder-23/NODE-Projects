...
console.log("Hint " + numgen);
let score = 0;
let guess = await inquirer.prompt([
    {
        message: "Welcome to the Number Guessing Game! Please enter your guess from a range on 1-5.",
        type: "number",
        name: "num",
    },
]);
...
guess = await inquirer.prompt([
    {
        message: "Please enter your guess from a range on 1-5.",
        type: "number",
        name: "num",
    },
]);
